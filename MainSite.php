...
<html lang="pt-br"> <!--Determinei a linguagem padrão do site-->
  ...
  <body>
    ...
    <div id="barra_menu">
       ...
       <nav id="cont_menu">
         <ul id="menu">
           <li><a id="link_menu" href="#">Home</a></li>
    ...
    <div id="slider">
      ...
      <h2 id="text">Camisas</h2>

    <div class="vitrine">
     <?php

        $items = array(
          ['nome'=>'Camiseta - Death 13 - DeadBy','imagem'=>'assents/camisas/Deadby Death 13.png','preco'=>'50'],
          ['nome'=>'Camiseta - Stay Away - DeadBy','imagem'=>'assents/camisas/Deadby scary pumpkin.png','preco'=>'50'],
          ['nome'=>'Camiseta - The Apple - DeadBy','imagem'=>'assents/camisas/Deadby The Apple.png','preco'=>'50']);
