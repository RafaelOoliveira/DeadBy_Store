  ...
  <body>
    ...
    <div id="barra_menu">
       ...
       <nav id="cont_menu">
         <ul id="menu">
           ...
           <li><a id="link_menu" href="#">Bonés</a></li>
    ...
    <div id="slider">
      ...
      <?php
            ...
            $items = array(
              ['nome'=>'Boné DeadBy','imagem'=>'assents/bonés/Boné DeadBy.jpg','preco'=>'40'],
              ['nome'=>'Boné Skull DeadBy','imagem'=>'assents/bonés/Boné Skull DeadBy.jpg','preco'=>'40']);
