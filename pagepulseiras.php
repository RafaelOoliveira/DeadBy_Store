...
<html lang="pt-br"> <!--Determinei a linguagem padrão do site-->
  ...
  <body>
    ...
    <div id="barra_menu">
       ...
       <nav id="cont_menu">
         <ul id="menu">
           ...
           <li><a id="link_menu" href="#">Pulseiras</a></li>
    ...
    <div id="slider">
      ...
      <h2 id="text">Pulseiras</h2>

      <div class="vitrine2">
      <?php

            $items = array(
              ['nome'=>'Pulseira Pedras Pretas - DeadBy','imagem'=>'assents/pulseiras/Pulseira DeadBy Pedras pretas.jpg','preco'=>'10'],
              ['nome'=>'Pulseira Pedras Vermelhas - DeadBy','imagem'=>'assents/pulseiras/Pulseira DeadBy Pedras Vermelhas.jpg','preco'=>'10']);
